<%-- 
    Document   : sortHot
    Created on : Jun 15, 2023, 8:19:14 PM
    Author     : Acer
--%>
         ...
         <div class="container">
                ...
                <div class="p1 py-3">
                    BIRD
                        ...
                        <%
                                ...
                                ArrayList<Bird> list = (ArrayList<Bird>) request.getAttribute("bhot");
            ...
            <div class="p1 py-3">
              ...
              <div class="p2 mb-3">
                    <div class="row py-3">
                        <%  
                            ArrayList<Accessory> list2 = (ArrayList<Accessory>) request.getAttribute("ahot");
