                    ...
                    <div class="col-md-8">
                        <form action="MainController" method="POST">
                            <div class="search">
                                ...
                                <button type="submit" value="SearchToUpdate" name="action"  style="background-color: #017a47; font-weight: bold;" class="btn btn-primary"><i class="fa-solid fa-magnifying-glass"></i></button>
                            </div> 
                        </form>
                    </div>
