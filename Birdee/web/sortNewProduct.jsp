<%-- 
    Document   : sortNewProduct
    Created on : Jun 15, 2023, 7:42:10 PM
    Author     : Acer
--%>
         ...
         <div class="container">
                ...
                <div class="p1 py-3">
                    BIRD
                        ...
                        <%
                                ...
                                ArrayList<Bird> list = (ArrayList<Bird>) request.getAttribute("bNew");
                            ...
                            <div class="col py-3">
                                <div class="card" style="width: 18rem;">
                                    ...
                                    <ul class="list-group list-group-flush">
                                        ...
                                        <li class="list-group-item"><a style="color: red"><%= BirdDAO.getBirdVote(b.getBird_id()) %> Star</a><a>, đã mua <%= BirdDAO.getBirdBuying(b.getBird_id())%></a></li>
            ...
            <div class="p1 py-3">
              ...
              <div class="p2 mb-3">
                    <div class="row py-3">
                        <%  
                            ArrayList<Accessory> list2 = (ArrayList<Accessory>) request.getAttribute("aNew");
                        ...
                        <div class="col py-3">
                            <div class="card" style="width: 15rem;">
                                ...
                                <ul class="list-group list-group-flush">
                                    ...
                                    <li class="list-group-item"><a style="color: red"><%= AccessoryDAO.getAccessoryVote(a.getAccessory_id()) %> Star</a><a>, đã mua <%= AccessoryDAO.getAccessoryBuying(a.getAccessory_id()) %></a></li>                             
