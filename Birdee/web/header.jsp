                ...
                <div class="row">
                    ...
                    <div class="col-md-6 text-end ">
                        <div class="he666">
                                ...
                                <c:if test="${uName == null}">
                                    <a style="color: white; text-decoration: none;" href="MainController?action=RegisterAccount">Đăng Ký </a>
                                    <i class="navbar__link-separator"></i>
                                    <a style="color: white; text-decoration: none;" href="login.jsp">Đăng Nhập</a>   
                                </c:if>
                ...
                <div class="row mt-5 ">
                    ...
                    <div class="col-md-2 logo ">
                        <div class="row">
                            ...
                            <div class="col-md-11"><a href="MainController?action="><img src="img/haiquangdoi.png" class="img-fluid" alt="Logo"></a></div>
