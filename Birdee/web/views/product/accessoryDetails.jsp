                    ...
                    <c:if test="${product.quantity != 0}">
                        <div class="mt-3 d-flex flex-column flex-md-row gap-3 align-items-md-center" id="show_buy">
                            <div class="d-flex gap-3 align-items-center">
                                ...
                                <button class="btn btn-outline-success btn-lg custom_btn_add">Thêm vào giỏ hàng</button>
                            </div>
                            <button class="btn btn-success btn-lg custom_btn_buynow">Mua ngay</button>
                        </div>
