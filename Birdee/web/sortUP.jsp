<%-- 
    Document   : sortUP
    Created on : Jun 15, 2023, 6:25:24 PM
    Author     : Acer
--%>
         ...
         <div class="container">
            <div class="row">
                ...
                <div class="p1 py-3">
                    BIRD
                        ...
                        <%                          
                                ArrayList<Bird> list = (ArrayList<Bird>) request.getAttribute("bpriceup");
            ...
            <div class="p1 py-3">
              ...
              <div class="p2 mb-3">
                    <div class="row py-3">
                        <%  
                            ArrayList<Accessory> list2 = (ArrayList<Accessory>) request.getAttribute("apriceup");
