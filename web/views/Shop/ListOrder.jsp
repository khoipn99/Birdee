            ...
            <div class="p-4 mb-5">
                ...
                <form action="listOrder" method="post">
                    <div class="mt-3 d-flex gap-4 align-items-center">
                        ...
                        <select name="statusID" class="form-select" id="city">
                            <option value="0" 
                    ...
                    <table class="table">
                        <thead>
                            <tr style="background-color: #21D19240;">
                                ...
                                <th scope="col" style="width: 120px;font-size: 13px">Xác nhận đã giao</th>
                            </tr>
                        </thead>
                        <tbody>
                            <c:forEach var="od" items="${list}">
                                <tr>
                                    ...
                                    <td style="height: 78px;">
                                        <div class="d-flex align-items-center" style="height: 100%;">
                                            <a>${od.statusOrder.statusValue}</a>
                                        </div>
                                    </td>
                                    <td style="height: 78px;">
                                        <c:if test="${od.statusOrder.statusOrderID == 2}">
                                                ...
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form method="POST" action="listOrder">
                                                                ...
                                                                <div class="col mb-4">
                                                                    <h6>Bạn muốn xác nhận đơn hàng có ID: ${od.oderDetailsID} giao thành công?</h6>
                                                                </div>
